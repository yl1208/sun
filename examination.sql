...
) ENGINE = InnoDB AUTO_INCREMENT = 7777 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '管理员信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (0, '管理员', '男', '13658377857', '1253838283@qq.com', '123456', '3132', '0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20190013 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '考试管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20190001, '2025年上期期末考试', '计算机网络', 1001, '2025-03-21', 120, '2025', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190002, '2025年上期期末考试', '数据库理论', 1002, '2025-03-07', 90, '2025', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190003, '2025年下期期末考试', '数据结构', 1003, '2025-02-27', 90, '2025', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190005, '2025年上期期末考试', '计算机导论', 1004, '2025-03-14', 90, '2025', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190006, '2025年上期期末考试', '软件工程', 1005, '2025-03-21', 120, '2022', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190007, '2025年上期期末考试', '操作系统', 1006, '2025-03-13', 120, '2022', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190008, '2025年下期期末考试', 'C语言', 1007, '2025-03-13', 120, '2022', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190009, '2025年上期期末考试', '高等数学', 1008, '2025-03-07', 90, '2022', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190010, '2025年下期期末考试', 'Python编程', 1009, '2025-04-20', 120, '2020', '2', '软件工程', '软件工程学院', 100, '期末考试', '代码规范很重要，注释要清晰，考试不慌张。');
INSERT INTO `exam_manage` VALUES (20190011, '2025年上期期末考试', '人工智能导论', 1010, '2025-03-28', 120, '2020', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '理论联系实际，才能在考试中脱颖而出。');
INSERT INTO `exam_manage` VALUES (20190012, '2025年下期期末考试', '离散数学', 1011, '2025-04-10', 90, '2020', '2', '网络工程', '软件工程学院', 100, '期末考试', '数学是计算机科学的基础，务必重视。');
INSERT INTO `exam_manage` VALUES (20190013, '2025年上期期末考试', 'Java语言程序设计', 1012, '2025-03-25', 120, '2020', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '面向对象编程，理解类和对象是关键。');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10029 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '填空题题库' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `fill_question` VALUES (10029, '计算机导论', '12', '12', '12', 2, '', '');
...
CREATE TABLE `judge_question`  (
  ...
  `section` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '所属章节',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10012 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '判断题题库表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '留言表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (38, '清平乐——会昌', '东方欲晓，莫道君行早', '2025-06-22');
...
CREATE TABLE `multi_question`  (
  ...
  `level` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10034 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '选择题题库表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `multi_question` VALUES (10033, '数据库理论', 'sda', 'asd', 'asd', 'asd', 'asd', 'A', '', 2, '1', '1');
INSERT INTO `multi_question` VALUES (10034, '计算机网络', 'DNS 服务器和DHCP服务器的作用是（）', '1234', '3423', '·213·', '3123', '', '略', 2, '', '');
...
INSERT INTO `paper_manage` VALUES (1004, 2, 10029);
INSERT INTO `paper_manage` VALUES (1002, 1, 10033);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '回复表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of replay
-- ----------------------------
INSERT INTO `replay` VALUES (38, 23, '踏遍青山人未老，风景这边独好', '2025-06-22');
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '成绩管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (4, 20190001, 2222, '计算机网络', NULL, 70, NULL, '2022-04-03');
INSERT INTO `score` VALUES (14, 20190002, 2222, '数据库理论', NULL, 78, NULL, '2022-04-20');
INSERT INTO `score` VALUES (15, 20190002, 2222, '数据库理论', NULL, 80, NULL, '2022-04-20');
INSERT INTO `score` VALUES (16, 20190002, 2222, '数据库理论', NULL, 83, NULL, '2022-04-20');
INSERT INTO `score` VALUES (17, 20190001, 1111, '计算机网络', NULL, 74, NULL, '2022-04-13');
INSERT INTO `score` VALUES (18, 20190001, 1111, '计算机网络', NULL, 70, NULL, '2022-04-10');
INSERT INTO `score` VALUES (20, 20190001, 3333, '计算机网络', NULL, 90, NULL, '2022-04-11');
INSERT INTO `score` VALUES (21, 20190001, 3333, '计算机网络', NULL, 92, NULL, '2022-04-12');
INSERT INTO `score` VALUES (27, 20190001, 2222, '计算机网络', NULL, 80, NULL, '2022-04-25');
INSERT INTO `score` VALUES (30, 20190001, 2222, '计算机网络', NULL, 0, NULL, '2022-04-29');
INSERT INTO `score` VALUES (31, 20190001, 2222, '计算机网络', NULL, 0, NULL, '2019-09-06');
INSERT INTO `score` VALUES (32, 20190001, 6666, '计算机网络', NULL, 0, NULL, '2023-05-23');
INSERT INTO `score` VALUES (33, 20190001, 6666, '计算机网络', NULL, 4, NULL, '2023-05-25');
INSERT INTO `score` VALUES (34, 20190001, 6666, '计算机网络', NULL, 2, NULL, '2023-05-25');
INSERT INTO `score` VALUES (35, 20190001, 6666, '计算机网络', NULL, 2, NULL, '2023-05-28');
INSERT INTO `score` VALUES (36, 20190001, 6666, '计算机网络', NULL, 0, NULL, '2025-06-23');
INSERT INTO `score` VALUES (37, 20190001, 6666, '计算机网络', NULL, 20, NULL, '2025-06-25');
INSERT INTO `score` VALUES (38, 20190002, 6666, '数据库理论', NULL, 2, NULL, '2025-06-25');
INSERT INTO `score` VALUES (39, 20190001, 6666, '计算机网络', NULL, 0, NULL, '2025-06-25');
INSERT INTO `score` VALUES (40, 20190001, 6666, '计算机网络', NULL, 0, NULL, '2025-06-26');
INSERT INTO `score` VALUES (41, 20190001, 6666, '计算机网络', NULL, 2, NULL, '2025-07-03');
INSERT INTO `score` VALUES (42, 20190001, 6666, '计算机网络', NULL, 2, NULL, '2025-07-03');
INSERT INTO `score` VALUES (43, 20190001, 6666, '计算机网络', NULL, 4, NULL, '2025-07-03');
INSERT INTO `score` VALUES (44, 20190005, 6666, '计算机导论', NULL, 0, NULL, '2025-11-04');
INSERT INTO `score` VALUES (45, 20190001, 6666, '计算机网络', NULL, 4, NULL, '2025-11-04');
INSERT INTO `score` VALUES (46, 20190001, 6666, '计算机网络', NULL, 2, NULL, '2025-11-05');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20200404 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '学生信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (11, '咸鱼', '2022', '计算机科学与技术', '1', '软件工程学院', '13585439532', 'gblw@163.com', '123456', '3412312', '男', '2');
INSERT INTO `student` VALUES (22, '李四', '2022', '计算机科学与技术', '2', '软件工程学院', '13658377857', '13658377857@sina.cn', '123456', '124123124535', '男', '2');
INSERT INTO `student` VALUES (33, '王五', '2022', '网络工程', '1', '软件工程学院', '18734538457', '18734538457@163.com', '123456', '2423423', '女', '2');
INSERT INTO `student` VALUES (44, '赵六', '2022', '信息工程', '2', '软件工程学院', '15523619564', '15523619564@163.com', '123456', '500234199704022353', '男', '2');
INSERT INTO `student` VALUES (55, '钱七', '2022', '信息工程', '1', '软件工程学院', '15583829425', '15583829425@163.com', '123456', '3242342', '男', '2');
INSERT INTO `student` VALUES (66, '张三', '2022', '软件工程', '2', '大数据与计算机学院', '12345678901', '123@qq.com', '123456', '1234567891234567', '男', '2');
INSERT INTO `student` VALUES (20200403, '张五', '22', 's', '1', '计算机', '123456789', '456789@qq.com', '123456', '12345678', '男', '2');
INSERT INTO `student` VALUES (20200404, '张五', '22', 's', '1', '计算机', '12345678', '456789', '123456', '12345678', '男', '2');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20251002 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '教师信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (111, '张', '软件工程学院', '女', '13598458442', '13598458442@163.com', '123456', '423423283498', '讲师', '1');
INSERT INTO `teacher` VALUES (222, '王', '软件工程学院', '男', '1231221312', '1231221312@163.com', '123456', '24241234', '讲师', '1');
